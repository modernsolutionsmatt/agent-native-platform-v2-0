...
```bash
git remote add encore encore://agent-native-platform-v2-0-aa9i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/agent-native-platform-v2-0-aa9i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/agent-native-platform-v2-0-aa9i/settings/integrations/github)
